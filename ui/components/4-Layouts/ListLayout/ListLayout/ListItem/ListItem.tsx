        ...
        <div className={styles.ListItem_container}>
            <div className={styles.text_container}>
                ...
                <div className={styles.videoChannel}>
                    <h4>{items.snippet.videoOwnerChannelTitle}</h4>
                </div>
                
            </div>
            <div onClick={() => handleClick(items.snippet.resourceId.videoId)} className={styles.image_container}>
                <Image src={items.snippet.thumbnails.medium.url}width={320} height={180} layout={"responsive"} alt={""}></Image>
